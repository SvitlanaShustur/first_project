...
# 
# 
# name = "https://www.namesite.com/folder/index.html"
...
# numbers = list(map(int,"3 44 6 8 9 12 7".split()))
# result = []
# for n in numbers:
#     if n % 2 != 0:
#         result.append(n)
#     # else:
#     #     print(f"видаляємо парні {n})")
...
# while numbers:
#     index2 = index % len(numbers)           #index = index % len(numbers)
#     numbers.pop(index2)
#     print(numbers)
...
# while numbers:
#     index = 4
#     index %= len(numbers)           #index = index % len(numbers)
#     numbers.pop(index)
#     print(numbers)
#---------------------------------------------------------------------------------
